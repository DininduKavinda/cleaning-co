                    ...
                    <div>
                        <div>
                            <div
                                ...
                                placeholder="Email"
                                    autocomplete="off"
                                    class="@error('email') is-invalid @enderror block w-full border-0 bg-transparent p-0 text-sm file:my-1 file:rounded-full file:border-0 file:bg-accent file:px-4 file:py-2 file:font-medium placeholder:text-muted-foreground/90 focus:outline-none focus:ring-0 sm:leading-7 text-foreground">
                                    @if ($errors->has('email'))
                        ...
                        <div>
                            <div
                                ...
                                <div class="flex items-center">
                                    ...
                                    type="password"
                                        class="@error('password') is-invalid @enderror block w-full border-0 bg-transparent p-0 text-sm file:my-1 placeholder:text-muted-foreground/90 focus:outline-none focus:ring-0 focus:ring-teal-500 sm:leading-7 text-foreground">
