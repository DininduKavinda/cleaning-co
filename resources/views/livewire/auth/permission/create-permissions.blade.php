                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Create Permission
                        ...
                        <div class="card-body">
                            <form wire:submit='saveData'>
                                ...
                                <div class="mb-3">
                                    ...
                                    <a href="{{ route('permissions') }}" wire:navigate class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm bg-gray-200 font-medium text-center text-black  rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">Back</a>
                              </div>
                            </form>
                        </div>
                    </div>
