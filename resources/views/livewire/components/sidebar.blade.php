<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            ...
            @can('view client')
                <li>
                    <a href="{{ route('clients') }}" wire:navigate
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-900 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Client Area </span>
                    </a>
                </li>
            @endcan
        ...
        {{-- <div id="dropdown-cta" class="p-4 mt-6 rounded-lg dark:bg-gray-800" role="alert">
            <p class="mb-3">
                <img src="{{ asset('download.gif') }}" />
            </p>
        </div> --}}
    </div>
</aside>
