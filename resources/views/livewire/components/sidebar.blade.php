        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('userss') }}" wire:navigate
            ...
            <li>
                <a href="" wire:navigate
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Course Categories</span>
                    <span
            ...
            <li>
                <a href="" wire:navigate
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Core Courses</span>
                </a>
            </li>
            <li>
                <a href="#"
