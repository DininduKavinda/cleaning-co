        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Create Province
                    ...
                    <form wire:submit.prevent='saveData'>
                        ...
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                for="">Country Name</label>
                            <select type="text" wire:model="form.country_id"
                        ...
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                for="">Province English Name</label>
                            <input type="text" wire:model="form.name_en"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500  @error('country_name') is-invalid @enderror" />
                        </div>
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                for="">Province Sinhala Name</label>
                            <input type="text" wire:model="form.name_si"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500  @error('country_name') is-invalid @enderror" />
                        </div>
                        <div class="mb-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                for="">Province Tamil Name</label>
                            <input type="text" wire:model="form.name_ta"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500  @error('country_name') is-invalid @enderror" />
                        </div>
                        <div class="mb-3">
                            <button type="submit"
